...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTrue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //인덱스에는 10이상은 올 수 가 없다.
                Log.i("MyQuiz", "questionIndex : " + questionIndex);
                if (questionIndex == 0) {
                    //알러트 다이얼로그를 이용하려면, AlertDialog.Builder 객체 생성
    ...
    // 유저의 대답을 체크하는 함수 : 맞췄으면 토스트로 "정답입니다","오답입니다" 를 보여준다.
            void evaluateUserAnswer(boolean userAnswer) {
                QuizModel q = questionArray[questionIndex];
                boolean answer = q.getmAnswer();

                //유저의 대답과, 현재 정답을 비교하여, 토스트하는 함수
                ...
                // 버튼 눌렀을때마다 스코어 변수 증가 하면서 화면의 표시
